                            ...
                            <DialogContent className="gap-6 p-12">
                                <DialogHeader className="flex">
                                    ...
                                    <DialogDescription className="text-center">
                                        ...
                                        máximo de nossos serviços, recomendamos criar uma conta. Se
                                        preferir, vocês também pode entrar sem fazer login.
                                    </DialogDescription>
                                </DialogHeader>
                ...
                <div className="flex w-3/6 flex-col items-center justify-center gap-5 text-center">
                    <div className="mr-52 flex flex-col justify-start gap-6 max-xl:mr-0 max-xl:items-center">
                        ...
                        <p className="max-xl:mx-440 mt-10 w-full text-left text-2xl font-extralight max-xl:px-56 max-xl:text-center max-lg:px-[5%] max-sm:mt-0 max-sm:text-base">
                            Nosso objetivo é simplificar o agendamento de serviços, oferecendo uma
                            plataforma intuitiva e acessível para clientes e profissionais. Encontre
                            o serviço ideal para suas necessidades.
                        </p>
                ...
                <div className="flex w-full flex-col items-center justify-center text-center">
                    <div className="ml-[20%] flex flex-col justify-start gap-6 max-xl:ml-0 max-xl:items-center ">
                        ...
                        <p className="mt-1 w-full text-left font-light max-xl:px-56 max-xl:text-center max-lg:px-[5%] max-sm:mt-0 max-sm:text-base">
                            Se você é um profissional em busca de mais oportunidades, junte-se à
                            nossa comunidade. Aumente sua visibilidade e simplifique seu agendamento
                        </p>
                    ...
                    <Accordion type="single" collapsible>
                        <AccordionItem className="py-5" value="item-1">
                            ...
                            <AccordionContent className="mr-56  text-xl font-extralight max-xl:text-lg max-sm:m-10 max-sm:text-base sm:m-0 sm:text-sm lg:text-base">
                                Você pode agendar um serviço sem criar uma conta preenchendo um
                                formulário simples com seu email, telefone e mensagem para o
                                profissional
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem className="py-5" value="item-2">
                            ...
                            <AccordionContent className="mr-56 text-xl font-extralight max-xl:text-lg max-sm:m-10 max-sm:text-base  sm:m-0 sm:text-base lg:text-base">
                                Ao criar uma conta, você terá acesso a recursos adicionais, como
                                histórico de agendamentos, perfis de profissionais favoritos e
                                comunicação direta com os prestadores de serviço.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem className="py-5" value="item-3">
                            ...
                            <AccordionContent className="mr-56 text-xl font-extralight max-xl:text-lg max-sm:m-10 max-sm:text-base sm:m-0 sm:text-base lg:text-base">
                                Sim, você pode cancelar ou reagendar um agendamento a qualquer
                                momento, basta acessar sua conta e selecionar a opção desejada no
                        ...
                        <AccordionItem className="py-5" value="item-4">
                            ...
                            <AccordionContent className="mr-56 text-xl font-extralight max-xl:text-lg max-sm:m-10 max-sm:text-base sm:m-0 sm:text-base lg:text-base">
                                Todos os profissionais listados na MeetFlow passam por um processo
                                de verificação rigoroso para garantir sua confiabilidade. Além
                                disso, os clientes podem deixar avaliações e comentários sobre suas
                                experiências.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem className="py-5" value="item-5">
                            ...
                            <AccordionContent className="mr-56 text-xl font-extralight max-xl:text-lg max-sm:m-10 max-sm:text-base sm:m-0 sm:text-base lg:text-base">
                                Não, o uso da plataforma MeetFlow é totalmente gratuito para os
                                clientes. Os profissionais pagam uma pequena taxa de transação ao
                                utilizar alguns recursos avançados.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
