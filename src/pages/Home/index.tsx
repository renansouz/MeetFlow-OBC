                ...
                <div className=" max-h-[80%] w-[90%] max-sm:mb-[10%] max-sm:h-full sm:h-full xl:w-[70%]">
                    <Accordion type="single" collapsible>
                        <AccordionItem className="py-5" value="item-1">
                            <AccordionTrigger className="sm:text- text-2xl font-normal text-foreground max-xl:text-xl max-sm:text-base lg:text-xl">
                        ...
                        <AccordionItem className="py-5" value="item-2">
                            <AccordionTrigger className="text-2xl font-normal text-foreground max-xl:text-xl max-sm:text-base sm:text-base lg:text-xl">
