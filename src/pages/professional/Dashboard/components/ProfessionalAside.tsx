...
export type NewServiceFormData = z.infer<typeof createNewServiceSchema>;
                            ...
                            <DialogContent className="p-6 ">
                                ...
                                <form action="" onSubmit={handleSubmit(handleCreateService)} className="">
                                    <section className="flex flex-col py-2">
                                        ...
                                        <div className="flex items-center justify-center">{errors.name && <p className="py-2 text-sm text-red-500">{errors.name.message}</p>}</div>
                                    </section>
                                    <section className="flex flex-col py-2">
                                        <div className="flex justify-between ">
                                            <label htmlFor="" className="block py-1 font-bold text-black">
                                        ...
                                        <div className="flex items-center justify-center">
                                            {errors.description && <p className="py-2 text-sm text-red-500">{errors.description.message}</p>}
                                        </div>
                                    </section>
                                    <section className="flex flex-col py-2">
                                        <div className="flex justify-between ">
                                        ...
                                        <div className="flex items-center justify-center">{errors.duration && <p className="py-2 text-sm text-red-500">{errors.duration.message}</p>}</div>
                                    </section>
                                    <section className="flex flex-col py-2">
                                        <div className="flex justify-between ">
                                            <label htmlFor="" className="block py-1 font-bold text-black">
                                        ...
                                        <div className="flex items-center justify-center">{errors.price && <p className="py-2 text-sm text-red-500">{errors.price.message}</p>}</div>
                                    </section>
