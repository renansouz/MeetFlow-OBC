...
import LogoMenor from '@/public/img/only-logo-white.png';
...
export const ProfessionalAside = () => {
    const [isServiceSuccess, setServiceSuccess] = useState(false);
    ...
    useEffect(() => {
        if (isServiceSuccess) {
            alert('Serviço realizado com sucesso!');
    ...
    const handleCreateService = async (userData: LoginFormData) => {
        try {
            ...
            toast.success('Serviço realizado com sucesso!');
            ...
            <div className="absolute left-2 top-1 h-10 items-center rounded-md bg-secondary sm:hidden">
                <Sheet>
                    ...
                    <SheetContent side={'left'} className="fixed">
                        <div className=" flex flex-col gap-y-10 max-lg:gap-0">
                            <div className="flex flex-col gap-y-1">
                                <Link to={'/'}>
                                ...
                                <Dialog>
                                    <DialogTrigger>
                                        <Button className="mx-2 mb-5 flex w-11/12 items-center justify-center rounded-full bg-indigo-700 px-5 hover:bg-indigo-800 max-lg:px-0">
                                            <Plus className="mr-2 text-indigo-100" />
                                            <p className="text-lg text-indigo-50 ">Criar</p>
                                        </Button>
                                    </DialogTrigger>
                                    <DialogContent className="p-6 ">
                                        <DialogHeader className="gap-3">
                                        ...
                                        <form action="" onSubmit={handleSubmit(handleCreateService)} className="">
                                            ...
                                            <section className="flex flex-col py-2">
                                                ...
                                                <div className="flex items-center justify-center">
                                                    {errors.description && <p className="py-2 text-red-500">{errors.description.message}</p>}
                                                </div>
                                            </section>
                                            <section className="flex flex-col py-2">
                                                <div className="flex justify-between ">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger>
                                            <Button asChild variant={'ghost'} className="flex h-11 items-center justify-start gap-3 px-10 py-7  ">
                                                <Link to="/professional/meus-agendamentos">
                                                    <PersonStanding />
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger>
                                            <Button asChild variant={'ghost'} className="flex h-11 items-center justify-start gap-3 px-10 py-7  ">
                                                <Link to="/professional/disponibilidade">
                                                    <Calendar />
                        ...
                        <div className="mt-[10%] flex w-full flex-col gap-y-1 max-lg:gap-0">
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipTrigger>
                                        <Button asChild variant={'ghost'} className="flex h-11 items-center justify-start gap-3 px-10 py-7 ">
                            ...
                            <Button asChild className="flex h-11 items-center justify-start gap-3 bg-inherit px-10 py-7 hover:bg-inherit  max-lg:px-0 ">
                                <Link className="justify-center gap-x-5" to={''}>
