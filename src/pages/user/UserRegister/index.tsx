                    ...
                    <form className="relative"  onSubmit={handleSubmit(handleFormSubmit)}>
                        ...
                        <div className="flex flex-col items-center justify-center gap-8 py-10">
                            ...
                            <section>
                                ...
                                <InputPassword placeholder="Digite sua senha novamente" id="confirmpPassword" passwordAppearence={passswordAppearenceState} {...register('confirmPassword')}/>
                            </section>
                            <section className="flex gap-2 ">
                                <input type="checkbox" name="" id="" onClick={handlePasswordAppearence} />
                                <label htmlFor="">Mostrar senha</label>
                            </section>
                            <Button className="mt-5 w-96 max-sm:w-64" onClick={() => handleFormSubmit} type='submit'>Entrar</Button>
                            <p>
                                Já possui uma conta?{' '}
