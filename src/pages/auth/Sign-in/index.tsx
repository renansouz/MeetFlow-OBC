        ...
        >
          <div className="flex w-full flex-col items-center justify-center">
            ...
            <div className="flex w-full flex-col items-center justify-center gap-y-1">
              <Button
                className="my-5 flex w-[20rem] items-center justify-center gap-2 border bg-card text-foreground hover:bg-primary/10"
                onClick={async () => loginGoogle()}
              >
                <img className="h-5 w-5" src="https://logopng.com.br/logos/google-37.svg" alt="" />
                Entre com Google
              </Button>
              <div className="mt-55 flex items-center justify-center gap-2">
