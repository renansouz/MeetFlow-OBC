...
export const Step1 = ({ setCurrentStepState }: stepProps) => {
  ...
  return (
    <div className="my-10 flex w-full flex-col items-center justify-center pt-[15%] max-xl:pt-[9%] max-sm:w-11/12 max-sm:pt-10">
      <Button
      ...
      <form
        className="my-5 flex h-full flex-col items-center justify-center px-10"
